(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(require('http'),require('https'),require('url'),require('assert'),require('stream'),require('tty'),require('util'),require('os'),require('zlib'),require('events'),require('buffer'),require('string_decoder')):typeof define==='function'&&define.amd?define(['http','https','url','assert','stream','tty','util','os','zlib','events','buffer','string_decoder'],f):(g=g||self,f(g.http,g.https,g.url,g.assert,g.stream$1,g.tty,g.util,g.os,g.zlib,g.events,g.buffer,g.string_decoder$1));}(this,function(http, https, url, assert, stream$1, tty, util, os, zlib, events, buffer, string_decoder$1){'use strict';http=http&&http.hasOwnProperty('default')?http['default']:http;https=https&&https.hasOwnProperty('default')?https['default']:https;url=url&&url.hasOwnProperty('default')?url['default']:url;assert=assert&&assert.hasOwnProperty('default')?assert['default']:assert;stream$1=stream$1&&stream$1.hasOwnProperty('default')?stream$1['default']:stream$1;tty=tty&&tty.hasOwnProperty('default')?tty['default']:tty;util=util&&util.hasOwnProperty('default')?util['default']:util;os=os&&os.hasOwnProperty('default')?os['default']:os;zlib=zlib&&zlib.hasOwnProperty('default')?zlib['default']:zlib;events=events&&events.hasOwnProperty('default')?events['default']:events;buffer=buffer&&buffer.hasOwnProperty('default')?buffer['default']:buffer;string_decoder$1=string_decoder$1&&string_decoder$1.hasOwnProperty('default')?string_decoder$1['default']:string_decoder$1;var bind = function bind(fn, thisArg) {
